...
# Title: Laboratorio 2
# Author: Cristian_Rugeles_Diana_Ariza_Sebastian_Torres
...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Laboratorio 2", catch_exceptions=True)
        ...
        self.Menu_grid_layout_0.addWidget(self._qtgui_vector_sink_f_0_win, 4, 0, 1, 1)
        for r in range(4, 5):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/media/diana/Nuevo vol/USUARIO/1Personal/1 UIS/2023-2/Comunicaciones II/lab2/black.jpg', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(N)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 100, 76)
